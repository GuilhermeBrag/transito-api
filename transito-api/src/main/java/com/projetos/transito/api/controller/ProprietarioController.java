...
import com.projetos.transito.domain.service.RegistroProprietarioService;
...
//        return proprietarioRepository.findByNomeContaining("ja");
    ...
    public ResponseEntity<Proprietario> buscar(@PathVariable Long proprietarioId) {
        return proprietarioRepository.findAllById(proprietarioId)
